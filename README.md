...
```
curl -L -s -k -O https://raw.githubusercontent.com/AlexPeregudov/dnscrypt-asuswrt-installer/master/installer && sh installer ; rm installer
```
...
```
curl -L -s -k -O https://raw.githubusercontent.com/AlexPeregudov/dnscrypt-asuswrt-installer/dnscrypt-proxy-v1/installer && sh installer dnscrypt-proxy-v1; rm installer
```
